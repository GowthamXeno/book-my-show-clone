    ...
    <>
      <div id="Footer" className="py-8" style={{ backgroundColor: "#333338" }}>
        <div className="flex justify-between px-8 items-center">
          ...
          <Link to="https://github.com/GowthamXeno/book-my-show-clone">
        ...
        <div className="flex items-center justify-center pb-5 pt-3 gap-3">
          ...
          <Link to="https://www.instagram.com/gowthamxeno" target="_blank">
            <button
              className="bg-background-100 hover:bg-background-200"
              style={ButtonStyle}
            >
          ...
          <Link
            to="www.linkedin.com/in/gowtham-m-fullstack-developer"
            target="_blank"
          >
            {" "}
            <button
